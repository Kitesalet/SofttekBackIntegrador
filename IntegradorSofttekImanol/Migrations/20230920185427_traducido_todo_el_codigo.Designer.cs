...
namespace IntegradorSofttekImanol.Migrations
{
    ...
    [Migration("20230920185427_traducido_todo_el_codigo")]
    partial class traducido_todo_el_codigo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IntegradorSofttekImanol.Models.Entities.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CodProject = 1,
                            Address = "xxxxxxxx",
                            CreatedDate = new DateTime(2023, 9, 20, 15, 54, 26, 395, DateTimeKind.Local).AddTicks(3907),
                            Name = "random",
                            State = 2
                        },
                        new
                        {
                            CodProject = 2,
                            Address = "xxxxxxxx",
                            CreatedDate = new DateTime(2023, 9, 20, 15, 54, 26, 395, DateTimeKind.Local).AddTicks(3921),
                            Name = "random",
                            State = 1
                        });
                });
            ...
            modelBuilder.Entity("IntegradorSofttekImanol.Models.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CodRole = 1,
                            CreatedDate = new DateTime(2023, 9, 20, 15, 54, 26, 395, DateTimeKind.Local).AddTicks(5267),
            ...
            modelBuilder.Entity("IntegradorSofttekImanol.Models.Entities.Service", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CodService = 1,
                            CreatedDate = new DateTime(2023, 9, 20, 15, 54, 26, 395, DateTimeKind.Local).AddTicks(4181),
                            Descr = "xxxxxxxx",
                            HourValue = 100m,
                            State = true
                        });
            ...
            modelBuilder.Entity("IntegradorSofttekImanol.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CodUser = 1,
                            CreatedDate = new DateTime(2023, 9, 20, 15, 54, 26, 395, DateTimeKind.Local).AddTicks(4837),
                            Dni = 39321874,
                            Name = "random",
                        ...
                        {
                            CodUser = 2,
                            CreatedDate = new DateTime(2023, 9, 20, 15, 54, 26, 395, DateTimeKind.Local).AddTicks(5038),
                            Dni = 39382743,
                            Name = "randoms",
                            Password = "2a80d4f36544c4bd8352ce27aa61c79a7dd4f7edde6cccebe94b38decbc5af5e",
                            Type = 2
                        ...
                        {
                            CodUser = 3,
                            CreatedDate = new DateTime(2023, 9, 20, 15, 54, 26, 395, DateTimeKind.Local).AddTicks(5122),
                            Dni = 39382743,
                            Name = "randomdd",
            ...
            modelBuilder.Entity("IntegradorSofttekImanol.Models.Entities.Work", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CodService = 1,
                            Cost = 8m,
                            CreatedDate = new DateTime(2023, 9, 20, 15, 54, 26, 395, DateTimeKind.Local).AddTicks(4283),
                            Date = new DateTime(2023, 9, 20, 15, 54, 26, 395, DateTimeKind.Local).AddTicks(4280),
                            HourQty = 2,
                            HourValue = 4m
                        });
                });
            ...
            modelBuilder.Entity("IntegradorSofttekImanol.Models.Entities.User", b =>
                {
                    b.HasOne("IntegradorSofttekImanol.Models.Entities.Role", "Role")
                        .WithMany("Usuarios")
                        .HasForeignKey("Type")
