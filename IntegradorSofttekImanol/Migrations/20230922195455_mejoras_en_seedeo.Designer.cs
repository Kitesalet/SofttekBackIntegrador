            ...
            modelBuilder.Entity("IntegradorSofttekImanol.Models.Entities.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 9, 22, 16, 54, 54, 641, DateTimeKind.Local).AddTicks(1107),
                            Name = "Oil Rig",
                            State = 1
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 9, 22, 16, 54, 54, 641, DateTimeKind.Local).AddTicks(1119),
                            Name = "Drilling",
                            State = 2
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 9, 22, 16, 54, 54, 641, DateTimeKind.Local).AddTicks(1120),
                            Name = "Refinery",
                            State = 3
                        });
                });
            ...
            modelBuilder.Entity("IntegradorSofttekImanol.Models.Entities.Service", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CodService = 1,
                            CreatedDate = new DateTime(2023, 9, 22, 16, 54, 54, 641, DateTimeKind.Local).AddTicks(1292),
                            Descr = "Maintenance",
                            HourValue = 100m,
                            State = true
                        },
                        ...
                        {
                            CodService = 2,
                            CreatedDate = new DateTime(2023, 9, 22, 16, 54, 54, 641, DateTimeKind.Local).AddTicks(1295),
                            Descr = "Inspection",
                            HourValue = 120m,
                            State = false
                        },
                        ...
                        {
                            CodService = 3,
                            CreatedDate = new DateTime(2023, 9, 22, 16, 54, 54, 641, DateTimeKind.Local).AddTicks(1297),
                            Descr = "Drilling",
                            HourValue = 150m,
                            State = true
                        },
                        ...
                        {
                            CodService = 4,
                            CreatedDate = new DateTime(2023, 9, 22, 16, 54, 54, 641, DateTimeKind.Local).AddTicks(1298),
                            Descr = "Assessment",
                            HourValue = 200m,
                            State = false
                        },
                        ...
                        {
                            CodService = 5,
                            CreatedDate = new DateTime(2023, 9, 22, 16, 54, 54, 641, DateTimeKind.Local).AddTicks(1300),
                            Descr = "Construction",
                            HourValue = 250m,
                            State = true
                        });
            ...
            modelBuilder.Entity("IntegradorSofttekImanol.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CodUser = 1,
                            CreatedDate = new DateTime(2023, 9, 22, 16, 54, 54, 641, DateTimeKind.Local).AddTicks(1791),
                            Dni = 39321874,
                            Name = "random",
                        ...
                        {
                            CodUser = 2,
                            CreatedDate = new DateTime(2023, 9, 22, 16, 54, 54, 641, DateTimeKind.Local).AddTicks(1877),
                            Dni = 39847635,
                            Name = "random",
                            Password = "3df84d8d2fd61fcbe9a904130b40ff617b662f7bd82c1c917a67f95314138302",
                            Type = 1
            ...
            modelBuilder.Entity("IntegradorSofttekImanol.Models.Entities.Work", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CodService = 1,
                            Cost = 8m,
                            CreatedDate = new DateTime(2023, 9, 22, 16, 54, 54, 641, DateTimeKind.Local).AddTicks(1390),
                            Date = new DateTime(2023, 9, 22, 16, 54, 54, 641, DateTimeKind.Local).AddTicks(1388),
                            HourQty = 2,
                            HourValue = 4m
                        });
                });
