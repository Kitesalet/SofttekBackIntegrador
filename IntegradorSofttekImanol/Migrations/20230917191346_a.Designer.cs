            ...
            modelBuilder.Entity("IntegradorSofttekImanol.Models.Entities.Proyecto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Direccion = "xxxxxxxx",
                            Estado = 2,
                            FechaAlta = new DateTime(2023, 9, 17, 16, 13, 45, 127, DateTimeKind.Local).AddTicks(9275),
                            Nombre = "random"
                        },
                        new
                        {
                            ...
                            Direccion = "xxxxxxxx",
                            Estado = 1,
                            FechaAlta = new DateTime(2023, 9, 17, 16, 13, 45, 127, DateTimeKind.Local).AddTicks(9286),
                            Nombre = "random"
                        });
                });
            ...
            modelBuilder.Entity("IntegradorSofttekImanol.Models.Entities.Rol", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaAlta = new DateTime(2023, 9, 17, 16, 13, 45, 128, DateTimeKind.Local).AddTicks(243),
            ...
            modelBuilder.Entity("IntegradorSofttekImanol.Models.Entities.Servicio", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Descr = "xxxxxxxx",
                            Estado = true,
                            FechaAlta = new DateTime(2023, 9, 17, 16, 13, 45, 127, DateTimeKind.Local).AddTicks(9479),
                            ValorHora = 0m
                        });
                });
            ...
            modelBuilder.Entity("IntegradorSofttekImanol.Models.Entities.Trabajo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CodServicio = 1,
                            Costo = 8m,
                            Fecha = new DateTime(2023, 9, 17, 16, 13, 45, 127, DateTimeKind.Local).AddTicks(9560),
                            FechaAlta = new DateTime(2023, 9, 17, 16, 13, 45, 127, DateTimeKind.Local).AddTicks(9564),
                            valorHora = 4m
                        });
                });
            ...
            modelBuilder.Entity("IntegradorSofttekImanol.Models.Entities.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Dni = 39321874,
                            FechaAlta = new DateTime(2023, 9, 17, 16, 13, 45, 128, DateTimeKind.Local).AddTicks(8),
                            Nombre = "random",
                            Tipo = 1
                        },
                        new
                        {
                            ...
                            Dni = 39382743,
                            FechaAlta = new DateTime(2023, 9, 17, 16, 13, 45, 128, DateTimeKind.Local).AddTicks(86),
                            Nombre = "randoms",
                            Tipo = 2
                        },
                        new
                        {
                            ...
                            Contrasena = "c2f48c5bdf5da0dab948e28cf1a9605256a62b0d0138c3ce2bca4467f14884ef",
                            Dni = 39382743,
                            FechaAlta = new DateTime(2023, 9, 17, 16, 13, 45, 128, DateTimeKind.Local).AddTicks(152),
                            Nombre = "randomdd",
                            Tipo = 2
                        });
                });
